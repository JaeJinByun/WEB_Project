...
<div class="inputform">
	...
	<div class="controlJ">               
	  	...
	  	<input id="tel1"  placeholder="전화번호" type="text" name="tel1" maxlength="3"> &emsp;
	...
	<div>
		...
		<input class="inputbutton" type="button" value="${btn_input_cancel}" onclick="location='main.html'">
	</div>
	</form>
</div>
